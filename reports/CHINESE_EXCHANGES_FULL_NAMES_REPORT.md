# Chinese Exchanges Full Names Report

## Задача

**Дата:** 2025-01-27  
**Задача:** В списке пространств имен по китайским биржам показывать полные названия на английском, а китайское название показывать в скобках после английского  
**Статус:** ✅ Завершено
...
- **19 строк добавлено, 3 строки изменено**
...
**Коммит:** `d1b447d` - Добавление китайских бирж с полными английскими названиями
