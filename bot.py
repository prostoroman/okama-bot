...
Задача: Проанализируй ВИЗУАЛЬНО каждый график и предоставь краткий, но информативный анализ графика, включая:
1. Основные тренды и паттерны, которые ты видишь на графиках
2. Ключевые уровни поддержки и сопротивления, визуальный и технический анализ
3. Оценка волатильности на основе визуального анализа
...
Задача: Предоставь анализ на основе доступной информации о компании и графика:
1. Краткая справка о бизнесе компании и отрасли
2. Ожидаемые тренды для данного временного периода, Ключевые факторы, влияющие на цену, Оценка рисков и возможностей
