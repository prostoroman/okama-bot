...
### 📊 Финансовый анализ
- **Анализ активов** - полная информация по одному активу с графиками цен
...
```
/asset VOO.US [период]  # Информация об активе с графиком цен
/chart SPY.US [период]  # График цен актива
...
| `/asset` | Информация об активе с графиком | `/asset VOO.US 1Y` |
| `/chart` | График цен актива | `/chart SPY.US 2Y` |
