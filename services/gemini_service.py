                ...
                "contents": [
                    {
                        "parts": [
                            {
                                "text": f"""Ты — ведущий портфельный аналитик уровня крупнейших инвестиционных фондов (BlackRock, Vanguard, Fidelity).
...
1. **АНАЛИЗ ТЕКУЩЕГО ПОРТФЕЛЯ:**
   - Оцени общую эффективность портфеля с учетом доступных метрик
...
Добавь дисклеймер о том, что анализ не является инвестиционной рекомендацией."""
                            }
                        ]
                    }
                ],
