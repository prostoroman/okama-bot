...
Используй строгий профессиональный тон, глубокую аналитику и структуру."""
        ...
        self.custom_prompts = {
            ...
            'data_comparison': {
                ...
                'format': 'Структурированный отчет с подзаголовками в формате Markdown, используй **жирный текст** для заголовков и ключевых метрик, четкий язык, профессиональные термины с пояснениями не более 4000 символов'
            },
    ...
    def _build_prompt(self, analysis_type: str, custom_data: str = "") -> str:
        ...
        # Добавляем язык ответа и инструкции по форматированию
        ...
        try:
            ...
            payload = {
                ...
                "generationConfig": {
                    ...
                    "topK": 40,
                    "topP": 0.95,
                    "maxOutputTokens": 8000,  # Увеличено для детального анализа нейроанализа
                }
            }
        ...
        try:
            ...
            payload = {
                ...
                "generationConfig": {
                    ...
                    "topK": 40,
                    "topP": 0.95,
                    "maxOutputTokens": 8000,  # Увеличено для детального анализа портфеля
                }
            }
